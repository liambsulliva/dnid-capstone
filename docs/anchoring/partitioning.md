...
<img src={require('./img/servingsize.webp').default} alt="Nutrition label showing 5 servings per container" width="400" style={{ display: 'block', marginBottom: 'var(--ifm-leading, 1.25rem)' }} />
