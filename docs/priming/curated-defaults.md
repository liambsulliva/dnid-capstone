...
Did you know that Safari still holds [close to 20%](https://www.yaguara.co/browser-market-share/) of the browser market share in 2026? Given [Google Chrome's dominance](https://www.yaguara.co/browser-market-share/), this feels... wrong.
...
Most people don't necessarily care about all of the bells and whistles that their program offers them, but they do care about having the options available to them (see [Autonomy Bias](../behavior/autonomy-bias)). Companies can leverage the options they mark as "on" by default to their advantage, knowing that most users will never bother to change them.

Looking at Apple's competitor Microsoft, they generated a bit of controversy around their [Windows Recall](https://en.wikipedia.org/wiki/Windows_Recall) feature because it was implemented in this way. Recall is a feature that records screenshots of your computer's screen in real time, feeding those images into an AI model that the user can leverage to reference information they may have vaguely remembered after the fact.
