...
<img src={require('./img/reachability.png').default} alt="A screenshot of an iOS contact page" width="400" />
...
It allows interfaces to be built for the widest range of users possible, fitting it neatly into the principles of **[Universal Design](https://en.wikipedia.org/wiki/Universal_Design)**.
