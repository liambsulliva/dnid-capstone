...
<img src={require('./img/breakage.webp').default} alt="A screenshot of the Starbucks app payment screen" width="400" style={{ display: 'block', marginBottom: 'var(--ifm-leading, 1.25rem)' }} />
