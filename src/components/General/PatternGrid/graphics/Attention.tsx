  ...
  return (
    ...
    >
      <style>{`
        ...
        :is(.patternGridCard:hover svg, svg.active) .sb-dot { opacity: 0.25; }
        :is(.patternGridCard:hover svg, svg.active) .sb-standout {
          transform: scale(1.4);
  ...
  return (
    ...
    >
      <style>{`
        ...
        :is(.patternGridCard:hover svg, svg.active) .vh-row { transform: scaleX(1); opacity: 1; }
        .vh-row { transform: scaleX(0.7); opacity: 0.4; }
        :is(.patternGridCard:hover svg, svg.active) .vh-r1 { transform: scaleX(1); opacity: 1; }
        :is(.patternGridCard:hover svg, svg.active) .vh-r2 { transform: scaleX(1); opacity: 1; }
        :is(.patternGridCard:hover svg, svg.active) .vh-r3 { transform: scaleX(1); opacity: 1; }
        :is(.patternGridCard:hover svg, svg.active) .vh-r4 { transform: scaleX(1); opacity: 1; }
        :is(.patternGridCard:hover svg, svg.active) .vh-r5 { transform: scaleX(1); opacity: 1; }
      `}</style>
  ...
  return (
    ...
    >
      ...
      <style>{`
        ...
        :is(.patternGridCard:hover svg, svg.active) .is-feed { transform: translateY(-30px); }
      `}</style>
  ...
  return (
    ...
    >
      <style>{`
        ...
        :is(.patternGridCard:hover svg, svg.active) .rd-badge-group {
